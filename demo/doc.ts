...
/&gt;</code></pre><h2 class="block at-heading" id="at-c08JhP17eUC" data-toc-id="at-c08JhP17eUC">块级悬浮菜单</h2><p class="block at-block">编辑器支持块级的悬浮菜单，需要自定引入<code>FloatMenu</code> 组件。<a target="_blank" rel="noopener noreferrer nofollow" class="at-link" href="https://github.com/Nice-PLQ/antd-richtext/blob/master/src/menus/FloatMenu/types.ts">config配置配置项</a></p><pre class="block at-code-block"><code class="language-typescript">import { useRef } from 'react';
